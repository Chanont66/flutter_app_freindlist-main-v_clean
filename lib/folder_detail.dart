                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                  // ?? = ดูว่าด้านซ้ายเป็น null มั้ยถ้าใช่ให้ขึ้นเป็นว่างๆ ถ้าไม่ก็ขึ้นข้อมูลปกติ
                                    (widget.folder['detail'] ?? '').toString(),
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            TextButton.icon(
                              onPressed: null,
                              icon: Icon(Icons.people,size: 24,color: Colors.blue.shade700),
                              label: Text('จำนวน: ${friends.length} คน',
